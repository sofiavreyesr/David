...
st.markdown(
    ...
    <style>
      :root{
        ...
        /* IMPORTANT: prevent Chrome forced-dark weirdness */
        color-scheme: light;
      }
      ...
      /* Make sure text stays readable (dark Chrome fix) */
      ...
      /* Form submit button (prevents black rectangle in dark Chrome) */
